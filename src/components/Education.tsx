...
import educ from '../assets/educprofile.png'
...
export const Education = () => {
    const educationData = [
        {
            id: 1,
            degree: 'Bachelor Science of Information Technology',
            institution: 'University of Cebu',
            duration: '2005 – 2009',
            details: 'Developed technical and analytical skills through coursework, projects, and collaborative academic activities.'
        }
    ]
  return (
            ...
            <div className='flex flex-col lg:flex-row items-center gap-16'>
                <div className='w-full lg:w-5/12 flex justify-center lg:justify-start' data-aos='fade-right'>
                    <div className='relative'>
                        ...
                        <div className='relative z-10 bg-[#111a3e] rounded-2xl overflow-hidden border border-[#1f1641]'>
                                <img src={educ} alt='Education' className='w-64 h-64 md:w-96 md:h-96 object-cover transform transition-transform duration-500 hover:scale-110'/>
                        </div>
                ...
                <div className='w-full lg:w-7/12 space-y-6' data-aos='fade-left'>
                    {educationData.map((edu) => (
                        <div key={edu.id} className='group relative p-6 rounded-2xl bg-[#111a3e] border border-[#1f1641] transition-all duration-300 hover:border-primary/50'> 
