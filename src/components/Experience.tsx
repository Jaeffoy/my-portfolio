  ...
  const Experiences: Experience[] = [
    ...
    },
    {
      ...
      desc: [
        ...
        'Sort, scan, image, organize, and archive documents based on document and form types.',
        'Identify and classify documents according to their purpose, contract requirements, and client specifications.',
        'Capture and enter relevant information into databases and processing systems with a high level of accuracy.',
        'Review and verify data extracted through automated data extraction tools to ensure data quality and accuracy.',
        'Process outbound client correspondence and other required documentation as assigned.',
        'Ensure completed and verified transactions are accurately transmitted to the appropriate department or next level of processing.',
        'Maintain compliance with company policies, client requirements, quality standards, and established procedures.',
        'Perform additional duties and responsibilities as assigned while meeting productivity, accuracy, and quality expectations.',
      ],
    },
    {
      id: 3,
